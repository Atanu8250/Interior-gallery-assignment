 ...
 * - Supports priority loading for above-fold images and lazy loading for below-fold.
 */
...
export default function InteriorDesignCard({ img, isAboveFold = false }: InteriorDesignCardProps) {
    return (
        <Link href={`/images/${img._id}`}>
            <article className={styles.masonryItem} aria-label={img.title}>
